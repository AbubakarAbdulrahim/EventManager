...
export default function Register(props) {
  ...
  function HandleRole(events){
    setRole(events.target.value);
  }
  ...
  return (
      ...
      <SignInContainer direction="column" justifyContent="space-between">
        ...
        <Card variant="outlined" sx={{alignItems:'center', overflow:'visible'}}>
          ...
          >
            <FormControl>
              <FormLabel sx={{color:'#0A7273'}} htmlFor="fullname">Fullname</FormLabel>
              <TextField
                id="fullname"
                type="text"
                name="fullname"
            ...
            <FormLabel sx={{color:'#0A7273', '&.Mui-focused': { color: '#0A7273' }}} htmlFor="role" className='select'>Role</FormLabel>
            <Select
                value={role}
                autoFocus
                required            
